                ...
                messages=[
                    {
                        "role": "system",
                        "content": (
                            "You execute code safely. Return stdout, stderr, exit status, "
                            "and a summary of side effects. Never escalate privileges."
                        ),
                    },
                    {"role": "user", "content": payload},
                ],
                compound_custom={"tools": {"enabled_tools": ["code_execution"]}},
            )
        except GroqUnavailableError as exc:
